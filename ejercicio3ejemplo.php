                 ...
                 <tbody>
                     <?php 
                        ...
                        if($indice>0){
                         for($i=0;$i<$indice;$i++){
                            echo "<tr>";
                             echo "<td>{$result->ciudades[$i]->ciudad}</td>";
                             echo "<td class='izq'>{$result->ciudades[$i]->poblacion}</td>";
                             echo "<td class='izq'>{$result->ciudades[$i]->superficie}m&sup2;</td>";
                             echo "<td class='izq'>{$result->ciudades[$i]->latitud}&deg;,&nbsp;{$result->ciudades[$i]->longitud}&deg;</td>";
                            echo "</tr>";
                         }
                     }
                     ?>
...
<fieldset class="formulario">
             <form action="ejercicio3ejemplo.php" method="post">
                <label for="columna">    
